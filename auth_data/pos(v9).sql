...
--
-- Host: 127.0.0.1
-- Generation Time: Jul 06, 2019 at 05:36 AM
...
(13, 3, '0', '500', '50', '2019-07-02 05:55:06', '2019-07-02 05:55:06'),
(14, 4, '0', '500', '50', '2019-07-02 06:03:47', '2019-07-02 06:03:47'),
(15, 4, '501', '1000', '70', '2019-07-02 06:03:47', '2019-07-02 06:03:47'),
(16, 5, '0', '500', '150', '2019-07-02 06:05:00', '2019-07-02 06:05:00');
...
(10, 'T shirt', 3, '2019-07-02 05:55:06', '2019-07-02 05:55:06'),
(11, 'Pant', 4, '2019-07-02 06:03:47', '2019-07-02 06:03:47'),
(12, 'T shirt', 5, '2019-07-02 06:05:00', '2019-07-02 06:05:00');
...
(3, 'Agent', 'Asif Iqbal', '45646456546', 1, NULL, 1, '2019-07-02 05:54:20', '2019-07-02 05:54:20'),
(4, 'Agent', 'Sheikh Kamal Hosen', '0174586955', 1, NULL, 2, '2019-07-02 06:03:00', '2019-07-02 06:34:51'),
(5, 'Staff', 'Asad Butt', '01784596855', 1, 2, NULL, '2019-07-02 06:04:33', '2019-07-02 06:04:33');
...
(1, 'K Fashion', 'admin@t.com', '01736555677', 'Dhaka', 'Dhaka', 'gfdfg', '1542', '15', 'store_q5rtOQ.jpg', 'sdfsfd', '2019-06-13 05:41:09', '2019-06-13 05:41:09'),
(2, 'XXXXX', 'x@x.com', '01874041655', 'Dhaka', 'Dhaka', 'xxxxxx XXXX xxxxxx', '1542', '1547', NULL, '546654 zzzzzzzzzx    xxxxxxxxs s           ssssssssssss', '2019-07-04 05:24:17', '2019-07-04 05:24:17');
...
(3, 'Usama Muneer', '5465465354', 'admin@test.com', '365 Reichert Ways\nSouth Virginie, NH 72013', 5, 'Mrs.', '1992-10-29', 'O+', '1982-10-15', 5, '16', NULL, NULL, NULL, 1, NULL, '$2y$10$Fl.R49pZ56zB5mo5r42J/eK4ZmlXt/U1kLoK.feZS7ZZNMJAtgDcC', NULL, '2019-07-05 21:35:09', '2019-07-05 21:35:09'),
...
--
ALTER TABLE `product_promotion`
  ADD CONSTRAINT `product_promotion_product_id_foreign` FOREIGN KEY (`product_id`) REFERENCES `products` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `product_promotion_promotion_id_foreign` FOREIGN KEY (`promotion_id`) REFERENCES `promotions` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Constraints for table `product_store`
--
ALTER TABLE `product_store`
  ADD CONSTRAINT `product_store_product_id_foreign` FOREIGN KEY (`product_id`) REFERENCES `products` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `product_store_store_id_foreign` FOREIGN KEY (`store_id`) REFERENCES `stores` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Constraints for table `promotions`
--
ALTER TABLE `promotions`
  ADD CONSTRAINT `promotions_store_id_foreign` FOREIGN KEY (`store_id`) REFERENCES `stores` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;
...
--
ALTER TABLE `purchase_item`
  ADD CONSTRAINT `purchase_item_product_id_foreign` FOREIGN KEY (`product_id`) REFERENCES `products` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `purchase_item_purchase_id_foreign` FOREIGN KEY (`purchase_id`) REFERENCES `purchases` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;
...
--
ALTER TABLE `stocks`
  ADD CONSTRAINT `stocks_purchase_item_id_foreign` FOREIGN KEY (`purchase_item_id`) REFERENCES `purchase_item` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `stocks_store_id_foreign` FOREIGN KEY (`store_id`) REFERENCES `stores` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `stocks_user_id_foreign` FOREIGN KEY (`user_id`) REFERENCES `users` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Constraints for table `stock_requisitions`
--
ALTER TABLE `stock_requisitions`
  ADD CONSTRAINT `stock_requisitions_product_store_id_foreign` FOREIGN KEY (`product_store_id`) REFERENCES `product_store` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;
...
--
-- Constraints for table `trans_child_categories`
--
ALTER TABLE `trans_child_categories`
  ADD CONSTRAINT `trans_child_categories_categories_foreign` FOREIGN KEY (`categories`) REFERENCES `trans_parent_categories` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;
