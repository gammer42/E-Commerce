...
--
-- Host: 127.0.0.1:3306
-- Generation Time: May 22, 2019 at 12:32 PM
...
CREATE TABLE IF NOT EXISTS `customers` (
  ...
  KEY `customers_upazila_id_foreign` (`upazila_id`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
(12, '2019_05_22_104624_create_sub_categories_table', 1),
(13, '2019_05_22_105135_create_products_table', 1);
...
CREATE TABLE IF NOT EXISTS `stores` (
  ...
  UNIQUE KEY `stores_vat_no_unique` (`vat_no`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE IF NOT EXISTS `suppliers` (
  ...
  `vat_reg_num` varchar(191) COLLATE utf8mb4_unicode_ci NOT NULL,
  `img` varchar(191) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `address` varchar(191) COLLATE utf8mb4_unicode_ci NOT NULL,
  `upazila_id` int(10) UNSIGNED NOT NULL,
  ...
  UNIQUE KEY `suppliers_vat_reg_num_unique` (`vat_reg_num`),
  UNIQUE KEY `suppliers_supplier_code_unique` (`supplier_code`),
  KEY `suppliers_upazila_id_foreign` (`upazila_id`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
DROP TABLE IF EXISTS `supplier_alerts`;
CREATE TABLE IF NOT EXISTS `supplier_alerts` (
  ...
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `supplier_alerts_supplier_id_foreign` (`supplier_id`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
