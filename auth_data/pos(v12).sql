...
--
-- Host: 127.0.0.1
-- Generation Time: Jul 11, 2019 at 12:56 PM
...
CREATE TABLE `accounts` (
  ...
  `type_of_account` tinyint(4) NOT NULL,
  `transaction_cost` int(11) NOT NULL,
  `description` text COLLATE utf8_unicode_ci NOT NULL,
  `initial_bal` varchar(191) COLLATE utf8_unicode_ci NOT NULL,
  `current_bal` varchar(191) COLLATE utf8_unicode_ci NOT NULL,
...
(1, 500, '50', '50', 1, '2019-07-03 02:28:22', '2019-07-03 22:42:02'),
(2, 50, '50', '50', 2, '2019-07-03 22:41:32', '2019-07-03 22:41:32'),
(3, 50, '350', '1500', 3, '2019-07-04 05:17:20', '2019-07-04 05:17:20'),
(4, 51, '350', '1500', 4, '2019-07-04 05:18:30', '2019-07-04 05:18:30'),
(5, 5, '350', '400', 5, '2019-07-04 05:20:33', '2019-07-04 05:20:33'),
(6, 5, '350', '400', 6, '2019-07-04 05:24:34', '2019-07-04 05:24:34');
...
(1, 'Agent', 'Asif Iqbal', '45646456546', 3, NULL, 1, '2019-07-06 21:59:48', '2019-07-06 21:59:48'),
(2, 'Staff', 'Asad Butt', '01784596866', 3, 4, NULL, '2019-07-06 22:00:06', '2019-07-06 22:00:24');
...
(40, '2019_07_03_100335_create_accounts_table', 13),
(44, '2019_05_29_060334_create_deliveries_table', 14),
(45, '2020_05_23_060321_pivot', 15),
(46, '2019_07_08_132013_create_sales_person_table', 16),
(47, '2019_07_10_101301_create_payments_table', 17),
(48, '2019_07_10_101333_create_orders_table', 17),
...
CREATE TABLE `payments` (
  ...
  `mobile_no` varchar(191) COLLATE utf8_unicode_ci DEFAULT NULL,
  `transaction_no` varchar(191) COLLATE utf8_unicode_ci DEFAULT NULL,
  `receiver_no` varchar(191) COLLATE utf8_unicode_ci DEFAULT NULL,
  `card_no` varchar(191) COLLATE utf8_unicode_ci DEFAULT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
...
(31, 'admin-read', 'Display Administrators Menu', '2019-07-05 21:35:07', '2019-07-05 21:35:07'),
(32, 'admin-show', 'Display Administrators list', '2019-07-05 21:35:07', '2019-07-05 21:35:07'),
(33, 'admin-create', 'Create New Administrator', '2019-07-05 21:35:07', '2019-07-05 21:35:07'),
(34, 'admin-update', 'Update/Edit Administrator', '2019-07-05 21:35:08', '2019-07-05 21:35:08'),
(35, 'admin-delete', 'Delete Administrator', '2019-07-05 21:35:08', '2019-07-05 21:35:08'),
(36, 'role-read', 'Display Role menu', '2019-07-05 21:35:08', '2019-07-05 21:35:08'),
(37, 'role-show', 'Display Role Details', '2019-07-05 21:35:08', '2019-07-05 21:35:08'),
(38, 'role-create', 'Create New Role', '2019-07-05 21:35:08', '2019-07-05 21:35:08'),
(39, 'role-update', 'Update/Edit Role', '2019-07-05 21:35:08', '2019-07-05 21:35:08'),
(40, 'role-delete', 'Delete a Role', '2019-07-05 21:35:08', '2019-07-05 21:35:08'),
(41, 'user-read', 'Display User Menu', '2019-07-05 21:35:08', '2019-07-05 21:35:08'),
(42, 'user-show', 'Display user Details', '2019-07-05 21:35:08', '2019-07-05 21:35:08'),
(43, 'user-create', 'Create New User', '2019-07-05 21:35:08', '2019-07-05 21:35:08'),
(44, 'user-update', 'Update/Edit User', '2019-07-05 21:35:08', '2019-07-05 21:35:08'),
(45, 'user-delete', 'Delete User', '2019-07-05 21:35:08', '2019-07-05 21:35:08');
...
(3, 2, 2, '2019-07-04 05:17:20', '2019-07-04 05:17:20');
...
(2, 465455, 'memo_6nwFi6.png', '2019-07-01', 35000, 1, '2019-07-02 23:18:04', '2019-07-02 23:18:04');
...
(5, 'developer', 'Front-end Developer', '2019-07-05 21:35:08', '2019-07-05 21:35:08'),
(6, 'manager', 'Assistant Manager', '2019-07-05 21:35:08', '2019-07-05 21:35:08'),
(7, 'owner', 'Project Owner', '2019-07-06 06:48:32', '2019-07-06 06:48:32'),
(8, 'Emni', 'Emni Developer', '2019-07-10 01:03:13', '2019-07-10 01:03:13');
...
(1, 500, '2012-03-06', '50', '50', 1, 1, 1, '2019-06-16 16:51:14', '2019-07-03 22:42:02'),
...
(7, 5, '2019-04-07', '350', '400', 2, 1, 2, '2019-07-04 05:20:33', '2019-07-04 05:24:34');
...
(3, 'Usama Muneer', '5465465354', 'admin@test.com', '365 Reichert Ways\r\nSouth Virginie, NH 72013', 5, 'Mrs.', '1992-10-29', 'O+', '1982-10-15', 5, '16', 'Usama Muneer_7841562582507.png', NULL, 1, 1, NULL, '$2y$10$xG2vLp2gCCDrWDL4zs/7oOUdtI9QvgvBcSbBwYLxpLHH2e2RNiWqu', 'ZseMHWSYncMugo2O2uCDnOf8vZKYObX0XPTN8qbANOU0XsBX8fQcpad1bX4e', '2019-07-05 21:35:09', '2019-07-08 04:41:47'),
(4, 'Asad Butt', '5465465324', 'me@test.com', '1282 Rosenbaum Flats Suite 726\nEast Wilburn, MN 63289', 5, 'Dr.', '1983-09-22', 'O+', '1987-03-10', 5, '15', NULL, NULL, NULL, 1, NULL, '$2y$10$YyuHo/Dy3dHl69bbxV3k7.HS/i1ateP2NUlG0d5i3G28HvfZ6c7wu', NULL, '2019-07-05 21:35:10', '2019-07-05 21:35:10');
...
--
ALTER TABLE `accounts`
  ADD CONSTRAINT `accounts_bank_id_foreign` FOREIGN KEY (`bank_id`) REFERENCES `banks` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;
...
--
ALTER TABLE `cost_configures`
  ADD CONSTRAINT `cost_configures_delivery_person_foreign` FOREIGN KEY (`delivery_person`) REFERENCES `delivery_persons` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;
...
--
ALTER TABLE `delivery_orders`
  ADD CONSTRAINT `delivery_orders_agent_id_foreign` FOREIGN KEY (`agent_id`) REFERENCES `delivery_agents` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  ...
  ADD CONSTRAINT `delivery_orders_delivery_cost_id_foreign` FOREIGN KEY (`delivery_cost_id`) REFERENCES `delivery_costs` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
