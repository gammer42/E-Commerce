...
--
-- Host: 127.0.0.1
-- Generation Time: Jul 02, 2019 at 05:10 PM
...
INSERT INTO `stocks` (`id`, `quantity`, `date`, `store_id`, `user_id`, `purchase_item_id`, `created_at`, `updated_at`) VALUES
(1, 50, '2012-03-06', 1, 1, 1, '2019-06-16 22:51:14', '2019-06-17 00:52:09'),
(2, 100, '2012-03-06', 1, 1, 1, '2019-06-16 22:51:31', '2019-06-16 22:51:31');
...
(1, 'Usama Muneer', '5465465354', 'admin@test.com', '4191 Dickinson Square\r\nNew Jazminside, AK 23652-9407', 5, 'Ms.', '1973-01-02', 'O+', '2014-12-01', 5, '15', 'Usama Muneer_3581561904933.png', NULL, 1, 1, NULL, '$2y$10$EGy2L70NqX8TOEeWXUrOa.hDR/Qb7vYyvmKHPxUgbGmzWC70o1vAq', 'z0H8GrU33EBTUiNpJKFZMYlHqF1klJS3pyboct3hNQIkkIWPBCdqKDtxhZ4i', '2019-06-29 05:14:05', '2019-06-30 08:28:53'),
(2, 'Asad Butt', '5465465324', 'me@test.com', '330 Jovanny Islands\nBorerside, DE 55090', 5, 'Dr.', '2002-03-23', 'O+', '1996-05-01', 5, '15', NULL, NULL, NULL, 1, NULL, '$2y$10$8mcRXXL5DSSe0k9CM6FJo.qnmMRXQ4jINFG5PKxIGB.yfxXzn.V6S', NULL, '2019-06-29 05:14:05', '2019-06-29 05:14:05');
...
--
ALTER TABLE `current_stocks`
  ADD CONSTRAINT `current_stocks_product_store_id_foreign` FOREIGN KEY (`product_store_id`) REFERENCES `product_store` (`id`) ON UPDATE CASCADE;
...
--
ALTER TABLE `customer_phone`
  ADD CONSTRAINT `customer_phone_customer_id_foreign` FOREIGN KEY (`customer_id`) REFERENCES `customers` (`id`) ON UPDATE CASCADE,
  ADD CONSTRAINT `customer_phone_phone_id_foreign` FOREIGN KEY (`phone_id`) REFERENCES `phones` (`id`) ON UPDATE CASCADE;
...
--
ALTER TABLE `product_store`
  ADD CONSTRAINT `product_store_product_id_foreign` FOREIGN KEY (`product_id`) REFERENCES `products` (`id`) ON UPDATE CASCADE,
  ADD CONSTRAINT `product_store_store_id_foreign` FOREIGN KEY (`store_id`) REFERENCES `stores` (`id`) ON UPDATE CASCADE;
...
--
ALTER TABLE `stock_requisitions`
  ADD CONSTRAINT `stock_requisitions_product_store_id_foreign` FOREIGN KEY (`product_store_id`) REFERENCES `product_store` (`id`) ON UPDATE CASCADE;
