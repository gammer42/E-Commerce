            ...
            <div class="portlet light bordered">
                <div class="portlet-title">
                    <div class="caption font-dark">
                        <span class="caption-subject bold uppercase">Edit Promotion</span>
                    </div>
                </div>
                <div class="portlet-body">
                    <form action="{{route('promotion.update', $promotion->id)}}" class="horizontal-form" method="POST">
                        @method('PUT')
                        @csrf
                        ...
                        <div class="form-body">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <select name="promotion_type" id="type" class="form-control" required>
                                            <option value="1" {{$promotion->type,1?'selected':''}}>Promotion on Product</option>
                                            <option value="2" {{$promotion->type,2?'selected':''}}>Promotion on Purchase</option>
                                            <option value="3" {{$promotion->type,3?'selected':''}}>Promotion on Card</option>
                                        </select>
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="form-group" id="minPurchase">
                                        ...
                                        <input type="text" id="min_purchase" name="min_purchase" class="form-control" value="{{ $promotion->minimum_buy }}" required disabled>
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <span class="text-danger">*</span>
                                        <input type="text" id="title" name="title" class="form-control" id="title" value="{{$promotion->title}}" required>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <select name="status" id="status" class="form-control" required>
                                            ...
                                            <option value="2" {{$promotion->status,2?'selected':''}}>Inactive</option>
                                            <option value="3" {{$promotion->status,3?'selected':''}}>Pending</option>
                                        </select>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <select name="discount" onchange="discount_type(this.value);" id="discount" class="form-control" required>
                                            <option value="1" {{$promotion->discount_type,1?'selected':''}}>Parcent (%)</option>
                                            <option value="2" {{$promotion->discount_type,2?'selected':''}}>Currency (৳)</option>
                                        </select>
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input type="number" id="amount" name="amount" class="form-control" value="{{$promotion->discount_amount}}" required>
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <div class="input-group date date-picker">
                                                    <input type="text" name="from_date" class="form-control" id="from_date" value="{{$promotion->start_from}}" required>
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <div class="input-group date date-picker">
                                                    <input type="text" name="to_date" class="form-control" id="to_date" value="{{$promotion->end_to}}" required>
                                                    <span class="input-group-btn">
                                                        <button class="btn default date-set" type="button">
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <span class="text-danger">*</span>
                                                <textarea class="form-control" name="description" id="description" rows="4" required>{{$promotion->description}}</textarea>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select name="store[]" multiple="multiple" id="my_multi_select1" class="multi-select" style="width:100% !important">
                                            ...
                                            @foreach($stores as $store)
                                                <option value="{{ $store->id }}"{{$promotion->stores->contains($store->id)?'selected':''}}> {{ $store->name }} </option>
                                            @endforeach
                                        </select>
                                    </div>
                                </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-2">
                                    <button type="submit" class="btn red btn-outline">Update</button>
                                </div>
                            </div>
            ...
            $('#category').change(function() {
                $("#category option:selected").each(function (){
                    ...
                    $('#sub_category').html(`<label class="control-label" for="subCat">Sub Category</label>
                                            <select name="type" id="subCat" class="form-control select2">
