                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-8">
                                                <select class="form-control" id="store_id" name="store_id" required>
                                                    ...
                                                    <option value="store_id">Store One</option>
                                                    <option value="store_id">Store Two</option>
                                                    <option value="store_id">Store Three</option>
                                                </select>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-8">
                                                <select class="form-control" id="customer_id" name="customer_id" required>
                                                    ...
                                                    <option value="customer_id">xxxxxxx</option>
                                                    <option value="customer_id">dddddddd</option>
                                                    <option value="customer_id">rrrrrrrr</option>
                                                </select>
                                            </div>
                                        </div>
                                    </div>
