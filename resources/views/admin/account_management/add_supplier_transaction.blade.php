            ...
            <div class="portlet light bordered">
                <div class="portlet-title">
                    <div class="caption font-dark">
                        <span class="caption-subject bold uppercase">Add Supplier Transaction</span>
                    </div>
                </div>
                                ...
                                <div class="col-md-7">
                                    <div class="row">
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-8">
                                                <input type="text" name="trans_id" id="trans_id" class="form-control" value="1213" readonly>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">
                                        ...
                                        <div class="form-group">
                                            <div class="col-md-4">
                                                <div class="radio-group">
                                                    <label class="radio-inline"><input type="radio" class="unpaidorder" name="com_radio" value="1" checked="checked">Unpaid Order</label>
                                                </div>
                                            </div>
                                            <div class="col-md-4">
                                                <div class="radio-group">
                                                    <label class="radio-inline"><input type="radio" class="advancepay" name="com_radio" value="2">Advance Payment</label>
                                                </div>
                                            </div>
                                            <div class="col-md-4">
                                                <div class="radio-group">
                                                    <label class="radio-inline"><input type="radio" class="refund" name="com_radio" value="3">Refund Amount</label>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    <span id="unpaidTable" class="unpaid"></span>
                                    <span class="creditbalance"></span>
                                    <div class="row amountpay">
                                        <div class="form-group">
                                            <div class="col-md-4">
                                                <label class="control-label" for="paid_amount">Amount Pay <span class="text-danger">*</span></label>
                                            </div>
                                            <div class="col-md-8">
            ...
            $("select option:selected").each(function () {
                if($(this).val() != "") {
                    ...
                    var unpaidTable =   '<div class="row">'+
                                            '<div class="form-group">'+
                                                '<div class="col-md-4">'+
                                                    '<label class="control-label" for="unpaid_purchases">Unpaid Purchases <span class="text-danger">*</span></label>'+
                                                '</div>'+
                                                '<div class="col-md-8">'+
    ...
    <script>
        $(".unpaidorder").click(function () {
                var unpaidTable =   '<div class="row">'+
                    ...
                    '</div>'+
                '</div>';
                $('.creditbalance').hide(700);
        $('.unpaid').show().html(unpaidTable);
    });
    </script>
    <script>
        $('.advancepay').click(function(){
            $('.unpaid, .creditbalance').hide(500);
            $('.amountpay').show(500);
        });
    </script>
    <script>
        $('.refund').click(function(){
            let creditbalance = '<div class="row">'+
                    '<div class="form-group">'+
                        '<div class="col-md-4">'+
                            '<label class="control-label" for="paid_amount">Credit Balance<span class="text-danger">*</span></label>'+
                        '</div>'+
                        '<div class="col-md-3">'+
                            '<input type="text" name="paid_amount" id="paid_amount" class="form-control" placeholder="Paid Amount" readonly>'+
                        '</div>'+
                        '<div class="col-md-5">'+
                ...
                $('.creditbalance').empty().html(creditbalance);
                $('.unpaid, .amountpay').hide(700);
                $('.creditbalance').show().html(creditbalance);
        });
    </script>
@endsection
