...
<div class="page-content">
    ...
    <ul class="page-breadcrumb breadcrumb">
            ...
            <li>
                <span class="active">&nbsp; Add New Supplier Return</span>
            </li>
        </ul>
    <!-- END PAGE BAR -->
    <!-- BEGIN PAGE TITLE-->
    <!-- <h3 class="page-title">Add Supplier Return
                ...
                <div class="portlet light bordered">
                    <div class="portlet-title">
                        <div class="caption">
                            ...
                            <span class="caption-subject font-dark sbold uppercase">Add New Supplier Return</span>
                        </div>
                    </div>
                    ...
                    <!-- BEGIN FORM-->
                    <form method="post" action="{{route('supplier_return.store')}}" id="form_sample_1" class="form-horizontal" enctype="multipart/form-data">
                    @csrf
                        <div class="form-body">
                            <div class="row">
                            ...
                            <div class="row">
                                <div class="col-md-8 col-md-offset-2">
                                    <div class="form-group">
                                        <div class="col-md-4">
                                            <label class="control-label">Purchase<span class="font-red">*</span></label>
                                        </div>
                                        <div class="col-md-8">
                            ...
                            <div class="row">
                                <div class="col-md-8 col-md-offset-2">
                                    <div class="form-group">
                                        <div class="col-md-4">
                                            <label class="control-label">Purchase Item<span class="font-red">*</span></label>
                                        </div>
                                        <div class="col-md-8">
                                            <select class="form-control" name="purchase_item_id" id="purchase_item_id" required>
                                                <option selected disabled>Select Purchase Invoice First</option>
                                            </select>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="row">
                                <div class="col-md-8 col-md-offset-2">
                                    <div class="form-group">
                                        <label class="control-label col-md-4">Return Cause
                                            <span class="required"> * </span>
                                        </label>
                                        <div class="col-md-8">
                                            <textarea type="text" name="cause" data-required="1" class="form-control" /></textarea>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-md-8 col-md-offset-2">
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-8">
                                            <input type="radio" name="supplier_returns" value="1" checked>Yes
                                            <input type="radio" name="supplier_returns" value="0">No
                                        </div>
                                    </div>
                                </div>
                            </div>
